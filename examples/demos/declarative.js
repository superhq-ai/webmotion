...
// <w-animation>), spec in docs/MOTION.md. Static presentation is plain CSS:
// classes and inheritance work in live preview and in export alike, because
// the rasterizer embeds the document's stylesheets. The live custom element is
// the preview; export rasterizes the same DOM to MP4.
...
<style>
  ...
  .tagline  { font-size: 34px; text-align: center; color: rgba(235, 238, 245, 0.62); }
  .chip {
    font: 500 25px 'SF Mono', ui-monospace, Menlo, monospace;
    line-height: 64px;
    text-align: center;
    white-space: nowrap;
...
<w-sequence from="40">
  <w-text class="tagline" motion="fade-up" x="0" y="392" width="1280">Every frame is a pure function. Export is a method call.</w-text>
</w-sequence>

<w-sequence from="70">
  <w-sequence from="0">
    <w-text class="chip" motion="pop-in" x="135" y="540" width="300" height="64"
            color="#9fb4ff">&lt;w-animate&gt;</w-text>
  </w-sequence>
  <w-sequence from="8">
    <w-text class="chip" motion="pop-in" x="475" y="540" width="380" height="64"
            color="#c2a8ff">motion="pop-in"</w-text>
  </w-sequence>
  <w-sequence from="16">
    <w-text class="chip" motion="pop-in" x="895" y="540" width="250" height="64"
            color="#8fd8b8">.export()</w-text>
  </w-sequence>
</w-sequence>
`;
...
export default {
  ...
  blurb:
    "This scene is markup, not code. Motion is elements: named animations in &lt;w-defs&gt;, " +
    "referenced with motion=&quot;...&quot;, one-off tweens inline, sequences for stagger. " +
    "Static styling is plain CSS and survives export.",
